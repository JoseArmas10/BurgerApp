...
// import PromotionImage from "../../assets/promotion/pro.png"; // IMAGE MISSING
        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center mb-5 mb-lg-0">
              ...
              <div style={{width: '100%', height: '400px', backgroundColor: '#f8f9fa', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '2px dashed #dee2e6'}}>
                <span style={{color: '#6c757d'}}>Promotion Image Placeholder</span>
              </div>
            </Col>
